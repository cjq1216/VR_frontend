    ...
    <div>
        <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item to="/user/news-interview"><i class="el-icon-date"></i> <span class="bread">VR资讯</span></el-breadcrumb-item>
                <el-breadcrumb-item><span class="bread">专访</span></el-breadcrumb-item>
            </el-breadcrumb>
        </div>
    ...
    export default {
        ...
        methods:{
            ...
            postTextArea(){
                ...
                self.$axios({
                    ...
                    data:{
                        ...
                        belong:"interview"+self.newsData.id
                    }
                }).catch((error)=>{
                    console.log(error);
                });
            ...
            getHotComments(id){
                ...
                self.$axios({
                    url:'/MessageLeaving/show/'+localStorage.getItem('ms_userid')+'?belong='+"interview"+id+'&condition=hot',
                    method:'get',
                    baseURL: self.hostURL,
                    // data:{
                        // condition:"hot",
        ...
        //2.获得最新评论
            getNewComments(id){
                ...
                self.$axios({
                    url:'/MessageLeaving/show/'+localStorage.getItem('ms_userid')+'?belong='+"interview"+id+'&condition=time',
                    method:'get',
                    baseURL: self.hostURL,
                    // data:{
                        // condition:"time",
