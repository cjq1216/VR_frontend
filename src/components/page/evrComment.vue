    ...
    export default {
        ...
        methods:{
            ...
            postTextArea(){
                ...
                self.$axios({
                    ...
                    data:{
                        ...
                        belong:"evr"+localStorage.getItem("salesModel")
                    }
                }).catch((error)=>{
                    console.log(error);
                });
            ...
            getHotComments(){
                ...
                self.$axios({
                    url:'/MessageLeaving/show/'+localStorage.getItem('ms_userid')+'?belong='+"evr"+localStorage.getItem("salesModel")+'&condition=hot',
                    method:'get',
                    baseURL: self.hostURL,
                    // data:{
                        // condition:"hot",
            ...
            getNewComments(){
                ...
                self.$axios({
                    url:'/MessageLeaving/show/'+localStorage.getItem('ms_userid')+'?belong='+"evr"+localStorage.getItem("salesModel")+'&condition=time',
                    method:'get',
                    baseURL: self.hostURL,
                    // data:{
                        // condition:"time",
            ...
            postProLike(val){
                ...
                self.$axios({
                    ...
                    baseURL: self.hostURL,
                    data:{
                        name:"evr"+localStorage.getItem("salesModel"),
                        value:val
                    }
                }).catch((error)=>{
                    console.log(error);
            ...
            proUnlikeClick(){
                ...
                //.log(self.pro_thumbs.state+" "+self.pro_thumbs.downvote);
