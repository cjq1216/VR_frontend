    ...
    <div>
        <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item to="/user/news-technology"><i class="el-icon-date"></i> <span class="bread">VR资讯</span></el-breadcrumb-item>
                <el-breadcrumb-item><span class="bread">技术</span></el-breadcrumb-item>
            </el-breadcrumb>
        </div>
...
//                hostURL:'http://119.23.175.192:8080/VR',
        ...
        methods:{
            ...
            proLikeClick(){
                ...
                //.log(self.news_thumbs.state+" "+self.news_thumbs.upvote);
            ...
            refreshNewData(){
                ...
                if(text!=""){
                    ...
                    //console.log("new_comments: "+self.new_data.new_comments);
                    //console.log("new_comments: "+self.new_data.new_comments[1].releasetime);
                }
            },
            //回复-热评
