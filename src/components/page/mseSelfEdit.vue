    ...
    <div>
        <div class="crumbs">
            <el-breadcrumb separator="/">
                ...
                <el-breadcrumb-item to="/user/mse-self">我的评测自媒体</el-breadcrumb-item>
                <el-breadcrumb-item>评测自媒体编辑</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div v-if="edit">
            <el-row class="vii">
                <form method="POST" action="/VR/upload">
                    <h3 class="step">1.请上传标题图像</h3>
                    <VueImgInputer ref="vii" v-model="picValue" :imgSrc="imgSrc" accept="image/*" theme="light"
                                   size="large" @onChange="fileChange"></VueImgInputer>
                </form>
            </el-row>
            <el-row class="title">
                <h3 class="step">2.请设置标题</h3>
                <input type="text" v-model="title" placeholder="文章标题" style="outline: none;">
            </el-row>
            <el-row class="ql">
                <h3 class="step" style="margin-bottom: 10px">3.请编写您的评测内容</h3>
