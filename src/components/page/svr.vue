    ...
    <div>
        <div class="crumbs">
            <el-breadcrumb separator="/">
                ...
                <el-breadcrumb-item to="/user/product-list"><span @click="toSvr">PC头显</span></el-breadcrumb-item>
                <el-breadcrumb-item to='/user/svr-comment'>产品简介</el-breadcrumb-item>
...
//                hostURL:"http://119.23.175.192:8080/VR",
        ...
        methods:{
            ...
            toSvr(){
                localStorage.setItem("activePane","svr");
            }
