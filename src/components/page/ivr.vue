    ...
    <div>
        <div class="crumbs">
            <el-breadcrumb separator="/">
                ...
                <el-breadcrumb-item to="/user/product-list"><span @click="toIvr">一体机</span></el-breadcrumb-item>
                <el-breadcrumb-item to='/user/ivr-comment'>产品简介</el-breadcrumb-item>
                                ...
                                <td>
                                    <div class="tab-content">
                                        <ul class="category">
                                            ...
                                            <li>
                                                <span class="para-name">播放器的最大输出电压(mV)
                                ...
                                <td>
                                    <div class="tab-content">
                                        <ul class="category">
                                            ...
                                            <li>
                                                <span class="para-name">跟踪范围(m)</span>
...
//                hostURL:"http://119.23.175.192:8080/VR",
        ...
        methods:{
            ...
            toIvr(){
                localStorage.setItem("activePane","ivr");
            }
